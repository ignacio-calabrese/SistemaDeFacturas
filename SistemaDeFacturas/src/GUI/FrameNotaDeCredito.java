...
public class FrameNotaDeCredito extends JFrame{
	...
	public FrameNotaDeCredito(NotaDeCredito notaDeCredito) {
		...
		nums = new JLabel("<html>"
				+ "<p>Fecha de Emisión: " + new SimpleDateFormat("dd/MM/yy HH:mm:ss").format(notaDeCredito.getFechaEmision()) + "</p>"
				+ "<p>Nota De Crédito N°: " + notaDeCredito.getNroNotaDeCredito() + "</p>"
